...
namespace Lean.Transition
{
	...
	{
		public static LeanState positionTransition(this Transform target, Vector3 position, float duration, LeanEase ease = LeanEase.Smooth)
		{
			return Method.LeanTransformPosition.Register(target, position, duration, ease); 
			//return target;
		}
	}
}